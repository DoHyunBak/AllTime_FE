        ...
        body: surveys.isEmpty
            ...
            : DelayedReveal(
                skeleton: ListView.separated(
                  ...
                  itemBuilder: (_, __) =>
                      const ShimmerSkeleton(height: 180, radius: 16),
                ),
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(height: 16),
                  itemBuilder: (ctx, i) =>
                      Appear(index: i, child: _SurveyCard(survey: surveys[i])),
                ),
              ),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AppColors.primary.withValues(alpha: 0.2), width: 1.0),
            ),
            child: Row(
              children: [
          ...
          ...survey.options.map((option) {
            final ratio =
                survey.totalVotes == 0 ? 0.0 : option.votes / survey.totalVotes;
          ...
          Row(
            ...
            children: [
              Text('총 ${survey.totalVoters}명 참여 중',
                  style: TextStyle(
                      fontSize: 12,
                      color: isDark
                          ? AppColors.textMutedDark
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                    '투표가 완료되었습니다! ${survey.prize} 추첨에 자동 응모되었습니다 🎁'),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 2,
              decoration:
                  const InputDecoration(hintText: '설문에 대한 설명을 추가해주세요 (선택)'),
              style: TextStyle(
                  color: primaryColor,
                ...
                child: ElevatedButton(
                    onPressed: () {
                      ...
                      if (options.length < 2) {
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text('최소 2개 이상의 옵션이 필요합니다.')));
                        return;
                      }
